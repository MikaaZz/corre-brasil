import { Accordion_personal } from '@corre-brasil/ui';
      ...
      <Accordion_personal
        ...
        accordionContent={
          <ul>
            ...
            <li>
              Caso você veja algum cone caído ou fora de alinhamento, por favor
              corrija o mesmo;
            </li>
            <li>
          ...
          <>
            ...
            <ul>
              <li>
                ...
                abastecimento de insumos para o atleta: água, isotônico, frutas;
              </li>
              <li>
